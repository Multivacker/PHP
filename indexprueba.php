...
#head {
	...
	text-indent: -500em;
	height: 125px;
	background: url(indexon.php?img=gifLogo) 0 0 no-repeat;
}
.utility {
	position: absolute;
	right: 4em;
...
ul.vhosts a, ul.aliases a, ul.projects a, ul.tools a {
	padding-left: 22px;
	background: url(indexon.php?img=pngFolder) 0 100% no-repeat;
}
ul.tools a {
	background: url(indexon.php?img=pngWrench) 0 100% no-repeat;
}
ul.aliases a {
	background: url(indexon.php?img=pngFolderGo) 0 100% no-repeat;
}
ul.vhosts a {
	background: url(indexon.php?img=pngFolderGo) 0 100% no-repeat;
}
...
dd ul li {
	...
	margin: 0;
	padding: 0 0 0 20px;
	background: url(indexon.php?img=pngPlugin) 2px 50% no-repeat;
	line-height: 1.6;
}
a {
	color: #024378;
...
#foot {
	...
	<link rel="shortcut icon" href="indexon.php?img=favicon" type="image/ico" />
</head>
